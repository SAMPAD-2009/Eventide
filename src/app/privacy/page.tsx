...
function getPrivacyContent() {
  // Construct the full path to the PRIVACY.md file
  ...
  try {
    ...
    console.error("Could not read PRIVACY.md:", error);
    return "The privacy policy could not be loaded. Please try again later.";
  }
}
